...
const Dashboard = (props) => {
  ...
  const [earnings, setTotalEarnings] = useState({});

  useEffect(() => {
    axios
      .get("/total-earnings")
      .then((response) => {
        var total_earnings = response.data;
                              ...
                              <tr>
                                <td>
                                  <div className="d-flex align-items-center">
                                    <div className="avatar-sm bg-light rounded p-1 me-2">
                                      <img
                                        src="/public/assets/images/products/img-4.png"
                                        alt=""
                                        className="img-fluid d-block"
                                      />
                                    </div>
                              ...
                              <tr>
                                ...
                                <td>
                                  <div className="d-flex align-items-center">
                                    <div className="flex-shrink-0 me-2">
                                      <img
                                        src="/public/assets/images/users/avatar-4.jpg"
                                        alt=""
                                        className="avatar-xs rounded-circle"
                                      />
                                    </div>
                        ...
                        <div className="acitivity-item py-3 d-flex">
                          ...
                          <div className="flex-grow-1 ms-3">
                            ...
                            <div className="d-inline-flex gap-2 border border-dashed p-2 mb-2">
                              ...
                              >
                                <img
                                  src="/public/assets/images/products/img-8.png"
                                  alt=""
                                  className="img-fluid d-block"
                                />
                              </Link>
                              ...
                              >
                                <img
                                  src="/public/assets/images/products/img-10.png"
                                  alt=""
                                  className="img-fluid d-block"
                                />
                              </Link>
                                ...
                                <div className="d-flex">
                                  <div className="flex-shrink-0 avatar-sm">
                                    <div className="avatar-title bg-light rounded">
                                      <img
                                        src="/public/assets/images/companies/img-1.png"
                                        alt=""
                                        height="30"
                                      />
                                    </div>
                              ...
                              <div className="card-body">
                                <div className="d-flex">
                                  <div className="flex-shrink-0 avatar-sm">
                                    <div className="avatar-title bg-light rounded">
                                      <img
                                        src="/public/assets/images/companies/img-8.png"
                                        alt=""
                                        height="30"
                                      />
                                    </div>
